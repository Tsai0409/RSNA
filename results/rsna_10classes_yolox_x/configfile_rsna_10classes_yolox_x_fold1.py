...
class Exp(MyExp):
    def __init__(self):
        ...
        ### need change ###
        self.max_epoch = 40
        self.train_ann = "/kaggle/working/duplicate/input/annotations/train_rsna_10classes_yolox_x___train_for_yolo_10level_v1_fold1_len12625.json"
        self.val_ann = "/kaggle/working/duplicate/input/annotations/valid_rsna_10classes_yolox_x___train_for_yolo_10level_v1_fold1_len3150.json"
        self.output_dir = "/kaggle/working/duplicate/results/rsna_10classes_yolox_x/fold1"
