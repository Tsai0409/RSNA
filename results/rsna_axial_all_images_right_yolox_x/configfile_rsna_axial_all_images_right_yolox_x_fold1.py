...
class Exp(MyExp):
    def __init__(self):
        ...
        ### need change ###
        self.max_epoch = 40
        self.train_ann = "/kaggle/working/duplicate/input/annotations/train_rsna_axial_all_images_right_yolox_x___train_axial_for_yolo_all_image_v1_fold1_len7692.json"
        self.val_ann = "/kaggle/working/duplicate/input/annotations/valid_rsna_axial_all_images_right_yolox_x___train_axial_for_yolo_all_image_v1_fold1_len1549.json"
        self.output_dir = "/kaggle/working/duplicate/results/rsna_axial_all_images_right_yolox_x/fold1"
