...
df = pd.read_csv(f'{WORKING_DIR}/csv_train/preprocess_holdout_4/train_with_fold_holdout_test.csv')
...
df.to_csv('train_for_yolo_10level_v1.csv_holdout_test', index=False)
