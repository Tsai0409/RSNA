...
class rsna_axial_ss_nfn_ResNet50V2(rsna_v1_ResNet50V2):
    def __init__(self, fold=0):
        ...
        self.train_df_path = 'input/csv_train/axial_classification_holdout_7/axial_classification_holdout.csv'
    ...
    def _build_dataframes(self):
        ...
        noise_df = pd.read_csv(
            'input/csv_train/noise_reduction_by_oof_holdout_9/noisy_target_level_th09_holdout.csv'
...
class rsna_axial_spinal_ResNet50V2(rsna_v1_ResNet50V2):
    def __init__(self, fold=0):
        ...
        self.train_df_path = 'input/csv_train/csv_train/axial_classification_holdout_7/axial_classification_holdout.csv'
        # self.train_df_path = '/kaggle/working/duplicate/csv_train/axial_classification_holdout_7/axial_classification_holdout.csv'
        self.train_df = pd.read_csv(self.train_df_path)
    ...
    def _build_dataframes_center(self):
        ...
        # train 資料：過濾 noisy
        noise_df = pd.read_csv(
            'input/csv_train/csv_train/noise_reduction_by_oof_holdout_9/noisy_target_level_th09_holdout.csv'
            # f'{WORKING_DIR}/csv_train/noise_reduction_by_oof_holdout_9/noisy_target_level_th09_holdout.csv'
        )
...
class rsna_saggital_mil_spinal_ResNet50V2(rsna_v1_ResNet50V2):
    def __init__(self, fold=0):  # 加上fold參數
        ...
        self.train_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_spinal_range2_rolling5.csv'
    ...
    def _build_dataframes_center(self):
        ...
        noise_df = pd.read_csv('input/csv_train/csv_train/noise_reduction_by_oof_holdout_9/noisy_target_level_th08_holdout.csv')
...
class rsna_saggital_mil_ss_ResNet50V2(rsna_v1_ResNet50V2):
    def __init__(self):
        ...
        self.train_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_right_ss_range2_rolling5.csv'
        ...
        self.add_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_left_ss_range2_rolling5.csv'
    ...
    def _build_dataframes_bilateral(self):
        ...
        # === 讀取右側資料 ===
        right_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_right_ss_range2_rolling5.csv'
        ...
        # === 讀取左側資料 ===
        left_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_left_ss_range2_rolling5.csv'
...
class rsna_saggital_mil_nfn_ResNet50V2(rsna_v1_ResNet50V2):
    def __init__(self):
        ...
        self.train_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_right_nfn_range2_rolling5.csv'
        ...
        self.add_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_left_nfn_range2_rolling5.csv'
    ...
    def _build_dataframes_bilateral(self):
        ...
        # === 讀取右側資料 ===
        right_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_right_nfn_range2_rolling5.csv'
        ...
        # === 讀取左側資料 ===
        left_df_path = 'input/csv_train/csv_train/sagittal_classification_holdout_8/sagittal_left_nfn_range2_rolling5.csv'
