...
train = pd.read_csv(f'{WORKING_DIR}/csv_train/preprocess_holdout_4/train_with_fold_holdout_test.csv')
...
train.to_csv('train_axial_for_yolo_all_image_v1_holdout_test.csv', index=False)
print('train_axial_for_yolo_all_image_v1_holdout_test.csv finish')
